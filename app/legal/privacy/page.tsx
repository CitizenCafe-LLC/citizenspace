...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for Citizen Space services, detailing how we collect, use, and protect your personal information.',
}
      ...
      <section className="pb-12">
        <div className="container">
          <div className="mx-auto max-w-4xl">
            ...
            <h1 className="mb-6 font-display text-4xl font-bold lg:text-5xl">Privacy Policy</h1>
          ...
          <div className="mx-auto max-w-4xl space-y-8">
            <Card>
              ...
              <CardContent className="prose max-w-none">
                <p>
                  This Privacy Policy describes how Citizen Space ("we," "us," or "our") collects,
                  uses, and shares information about you when you use our services, including our
                  coworking facilities, cafe, website, and mobile application.
                </p>
                <p>
                  We are committed to protecting your privacy and handling your personal information
                  responsibly. This policy explains your privacy rights and how the law protects
                  you.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <ul>
                  <li>
                    <strong>Performance of contract:</strong> To provide services you've requested
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Consent:</strong> For marketing communications (where required)
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <p>
                  While we strive to protect your personal information, no security system is
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Marketing:</strong> Personalize advertisements (with consent)
                  </li>
                </ul>
                ...
                <p>
                  ...
                  cookies may limit functionality of our services.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <p>
                  Account information is typically retained for 7 years after account closure. Usage
                  logs and analytics data are retained for 2 years.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                <p>
                  Your information may be processed in countries other than your residence. We
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                <p>
                  ...
                  collected personal information from a child under 18, we will delete it promptly.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                <p>
                  ...
                  use of our services after changes take effect constitutes acceptance of the
                  updated policy.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <ul>
                  <li>
                    <strong>Email:</strong> privacy@citizenspace.com
                  </li>
                  <li>
                    <strong>Phone:</strong> (831) 295-1482
                  </li>
                  <li>
                    <strong>Mail:</strong> 420 Pacific Ave, Santa Cruz, CA 95060
                  </li>
                </ul>

                <p>
                  <strong>EU Representative:</strong> For EU-related inquiries, contact our Data
                  Protection Officer at dpo@citizenspace.com
                </p>
              </CardContent>
            </Card>
          </div>

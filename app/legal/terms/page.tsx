          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <p>
                  These Terms apply to all visitors, users, and customers of Citizen Space 
                  services, whether you are a casual visitor, day pass holder, or member.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <p>
                  ...
                  Membership details, pricing, and terms are available on our website and 
                  subject to change.
                </p>
                
                <h4>3.2 Access Cards and Security</h4>
                <p>
                  Members receive access credentials (physical cards or digital keys) that 
                  must not be shared, duplicated, or transferred. Lost or stolen access 
                  credentials must be reported immediately.
                </p>
                
                <h4>3.3 Guest Policies</h4>
                <p>
                  Members may bring guests subject to availability and applicable fees. 
                  Members are responsible for their guests' conduct and compliance with 
                  these Terms.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <p>
                  Membership fees are due monthly in advance and are non-refundable unless 
                  otherwise specified. Prices are subject to change with 30 days notice.
                </p>
                
                <h4>5.2 Additional Services</h4>
                <p>
                  Charges for meeting rooms, printing, cafe purchases, and other services 
                  are billed separately and are due immediately upon use.
                </p>
                
                <h4>5.3 Late Payments</h4>
                <p>
                  Late payments may result in access suspension. A late fee may apply for 
                  payments more than 5 days overdue.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <p>
                  Memberships may be cancelled with 30 days written notice. No refunds 
                  for partial months unless required by law.
                </p>
                
                <h4>6.2 Day Pass Refunds</h4>
                <p>
                  Day passes are non-refundable once activated. Unused day passes may 
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                <p>
                  Citizen Space is not liable for any indirect, incidental, special, 
                  consequential, or punitive damages, including loss of data, profits, 
                  or business interruption.
                </p>
                <p>
                  Users are responsible for their personal belongings. Citizen Space 
                  provides no warranty against theft, damage, or loss of personal property.
                </p>
                <p>
                  Our total liability shall not exceed the amount paid by the user in 
            ...
            <Card>
              ...
              <CardContent className="prose max-w-none">
                ...
                <p>
                  Significant changes will be communicated via email to members and 

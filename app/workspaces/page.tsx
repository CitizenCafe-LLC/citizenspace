...
import { LampDesk as Desk, Users, Shield, Phone, Wifi, Coffee, Clock, ArrowRight, Zap, Volume2 } from 'lucide-react';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Workspaces',
  description: 'From hourly desks to dedicated team pods, find the perfect workspace solution in our coworking zone.',
};
...
const testimonials = [
  {
    quote: "The perfect blend of community and productivity. I've been working here for two years and love the energy.",
    author: "Sarah Johnson",
    role: "Startup Founder"
  },
  {
    quote: "Great coffee, reliable internet, and a welcoming atmosphere. The day passes are perfect when I need a change of scenery.",
    author: "Mike Chen",
    role: "Software Developer"
  },
  {
    quote: "Our team pod has been a game-changer. It's like having our own office but with all the coworking benefits.",
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              From quick hourly sessions to dedicated team spaces, we have workspace solutions 
              for every working style. All behind our coworking gate with premium amenities.
            </p>
              ...
              <Card key={index} className="card-hover">
                <Link href={workspace.href}>
                  <CardHeader>
                    ...
                    <CardTitle className="font-display text-xl text-center">{workspace.title}</CardTitle>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="font-display text-xl font-semibold mb-2">Check In</h3>
              <p className="text-muted-foreground">Use your membership card or day pass to access the coworking zone through our gate</p>
            </div>
            
            <div className="text-center">
              <div className="mx-auto mb-4 p-4 rounded-full bg-cs-sun/10 w-16 h-16 flex items-center justify-center">
                <span className="text-2xl font-bold text-cs-caramel">2</span>
              </div>
              <h3 className="font-display text-xl font-semibold mb-2">Find Your Spot</h3>
              <p className="text-muted-foreground">Choose any available desk or use our app to reserve specific seats and meeting rooms</p>
            </div>
            
            <div className="text-center">
              <div className="mx-auto mb-4 p-4 rounded-full bg-cs-apricot/10 w-16 h-16 flex items-center justify-center">
                <span className="text-2xl font-bold text-cs-apricot">3</span>
              </div>
              <h3 className="font-display text-xl font-semibold mb-2">Get to Work</h3>
              <p className="text-muted-foreground">Enjoy all amenities including cafe ordering, printing, and meeting room access</p>
            </div>
          </div>
        </div>
      </section>

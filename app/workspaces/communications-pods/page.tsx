...
export const metadata: Metadata = {
  ...
  description: 'Private phone booth style rooms for calls and video meetings. Soundproof spaces perfect for confidential conversations.',
};
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-display text-4xl lg:text-6xl font-bold mb-6">
              Your Private{' '}
              <span className="gradient-text">Call Sanctuary</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Card className="max-w-md mx-auto">
              <CardHeader className="text-center">
                ...
                <div className="text-4xl font-bold text-cs-blue mb-2">$5/hour</div>
            ...
            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg max-w-2xl mx-auto">
              <p className="text-sm text-blue-800">
                ...
                from your workspace time. If you're paying hourly for a desk ($2.50/hour), 
                you'll also pay for pod usage ($5/hour) during your call.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="font-display text-xl font-semibold mb-2">Book Online</h3>
                <p className="text-muted-foreground">Reserve your pod through our website or mobile app</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-display text-xl font-semibold mb-2">Access Your Pod</h3>
                <p className="text-muted-foreground">Use your access card or app to enter the pod at your reserved time</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-display text-xl font-semibold mb-2">Make Your Call</h3>
                <p className="text-muted-foreground">Enjoy complete privacy and professional acoustics</p>
              </div>
            </div>
          </div>
        </div>

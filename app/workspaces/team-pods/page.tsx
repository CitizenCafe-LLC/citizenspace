...
export const metadata: Metadata = {
  title: 'Team Pods',
  description:
    'Dedicated private spaces for growing teams. Monthly commitments with custom setups and exclusive amenities.',
}
...
const testimonials = [
  {
    quote:
      'Having our own pod has been game-changing. We have the privacy we need for client work while still being part of the coworking community.',
    author: 'Sarah Kim',
  ...
  {
    quote:
      'The custom setup process was seamless. They understood our workflow and created a space that actually improves how we collaborate.',
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mb-6 font-display text-4xl font-bold lg:text-6xl">
              Your Team's <span className="gradient-text">Private Workspace</span>
            </h1>
            <p className="mb-8 text-xl text-muted-foreground">
              Dedicated, customizable spaces for growing teams. Enjoy the benefits of coworking with
              the privacy and control of your own office space.
            </p>
              ...
              <Card key={index} className="card-hover">
                <CardHeader>
                  ...
                  <div className="text-center">
                    <Badge variant="outline" className="font-semibold text-cs-blue">
                      {pod.pricing}
                    </Badge>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <h4 className="mb-1 font-semibold">Ideal for:</h4>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Team pods require a minimum 3-month commitment. We offer flexible terms after
                    the initial period with 30-day notice for changes.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Absolutely! We work with your team to configure furniture, add branding, and
                    create the optimal layout for your workflow. Some structural changes may require
                    approval.
                  </p>
                </CardContent>
              </Card>

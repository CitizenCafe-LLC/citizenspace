...
export const metadata: Metadata = {
  title: 'Mobile App',
  description: 'Download the Citizen Space app for iOS and Android. Book desks, order coffee from your seat, and manage your membership on the go.',
};
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Book desks, order coffee from your seat, and manage your membership 
              with our powerful mobile app. Available for iOS and Android.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {appFeatures.map((feature, index) => (
                <Card key={index}>
                  <CardHeader>
                    <feature.icon className="h-8 w-8 text-cs-blue mb-3" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {screenshots.map((screenshot, index) => (
                <div key={index} className="text-center">
                  <div className="aspect-[9/16] bg-muted rounded-2xl flex items-center justify-center mb-6 max-w-sm mx-auto">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card>
                <CardHeader>
                  <Zap className="h-8 w-8 text-cs-sun mb-3" />
                  <CardTitle>Faster Experience</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Book desks 3x faster than the web interface. Optimized for mobile 
                    with offline capabilities and instant sync.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <Bell className="h-8 w-8 text-cs-apricot mb-3" />
                  <CardTitle>Smart Notifications</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Get notified when your favorite desks open up, your order is ready, 
                    or events are starting.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <QrCode className="h-8 w-8 text-cs-caramel mb-3" />
                  <CardTitle>Contactless Access</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Skip the front desk with QR code entry. Your phone becomes 
                    your key to the space.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <Download className="h-8 w-8 text-cs-blue mb-3" />
                  <CardTitle>Offline Capability</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    View your bookings and access key features even when connectivity 
                    is spotty. Syncs when you're back online.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-left p-4">Why We Need It</th>
            ...
            <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-sm text-green-800">
                <strong>Privacy First:</strong> All permissions are optional and can be managed 
                in your phone's settings. The app works without any permissions, though some 
      ...
      <section className="py-20 bg-gradient-to-r from-cs-blue/10 to-cs-sun/10">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of members already using the app to enhance their 
              Citizen Space experience
            </p>

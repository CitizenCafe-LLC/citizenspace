...
export const metadata: Metadata = {
  title: 'Gallery',
  description: 'Explore our vibrant coworking and cafe space through photos of our community, events, and beautiful San Francisco location.',
};
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-display text-4xl lg:text-6xl font-bold mb-6">
              See Our{' '}
              <span className="gradient-text">Vibrant Community</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8">
              From quiet focus sessions to lively workshops, explore the energy and atmosphere 
              that makes Citizen Space a unique place to work and connect.
            </p>
              ...
              <TabsContent key={category.id} value={category.id}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {galleryImages
                    ...
                    .map((image) => (
                      <Card key={image.id} className="overflow-hidden card-hover group">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Schedule an in-person tour or explore our virtual walkthrough to get 
              the full Citizen Space experience.
            </p>

...
export const metadata: Metadata = {
  title: 'Blog',
  description: 'Insights on coworking, remote work, San Francisco culture, and coffee. Stories from our community and industry thoughts.',
};
...
const blogPosts = [
  {
    ...
    excerpt: 'How coworking spaces have transformed from simple desk rentals to thriving communities that foster innovation and connection.',
  ...
  },
  {
    ...
    excerpt: 'Exploring the relationship between coffee culture and creative productivity in modern workspaces.',
    content: 'Full blog post content would go here...',
  ...
  },
  {
    ...
    excerpt: 'Strategies for maintaining strong team connections when your workforce spans home offices and coworking spaces.',
    content: 'Full blog post content would go here...',
  ...
  },
  {
    ...
    excerpt: 'How the post-pandemic landscape has created new opportunities for startups and independent workers in SF.',
    content: 'Full blog post content would go here...',
  ...
  return (
    <div className="py-12">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Insights on coworking, remote work, Santa Cruz culture, and the intersection 
              of coffee and creativity. Written by our team and community members.
            </p>
              ...
              {categories.map((category) => (
                <Card key={category.id} className="card-hover cursor-pointer">
                  <CardContent className="p-6 text-center">
                    <category.icon className="h-8 w-8 mx-auto mb-3 text-cs-blue" />
      ...
      <section className="pb-12">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            <h2 className="font-display text-2xl font-bold mb-8">Featured Article</h2>
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-semibold text-sm">{blogPosts[0].author.name}</div>
      ...
      <section className="pb-20">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            <h2 className="font-display text-2xl font-bold mb-8">Recent Articles</h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Get our latest articles, community updates, and event announcements 

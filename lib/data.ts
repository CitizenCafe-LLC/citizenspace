...
export const siteSettings: SiteSettings = {
  ...
  description:
    'A caffeinated coworking hub with hourly seats, day passes, memberships, and great coffee in Santa Cruz.',
  logo: '/logo.svg',
  address: {
...
export const partners: Partner[] = [
  {
    ...
    type: 'roaster',
    description:
      'Mission-based roaster known for their meticulous approach to sourcing and roasting.',
...
export const testimonials: Testimonial[] = [
  {
    id: 'sarah-founder',
    quote:
      "The perfect blend of community and productivity. I've been a member for two years and can't imagine working anywhere else.",
  ...
  },
  {
    id: 'mike-developer',
    quote:
      'Great coffee, reliable internet, and a welcoming atmosphere. The day passes are perfect for when I need a change of scenery.',
    author: 'Mike Chen',
